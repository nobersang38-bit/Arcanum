	...
	namespace Items {
		...
		namespace ItemSlot {
			namespace Weapon {
				...
				UE_DEFINE_GAMEPLAY_TAG_COMMENT(Slot1, "Arcanum.Items.ItemSlot.Weapon.Slot1", "무기슬롯1");
				UE_DEFINE_GAMEPLAY_TAG_COMMENT(Slot2, "Arcanum.Items.ItemSlot.Weapon.Slot2", "무기슬롯2");
		...
		namespace Rarity {
			...
			namespace Common {
				namespace Weapon {
					UE_DEFINE_GAMEPLAY_TAG_COMMENT(Root, "Arcanum.Items.Rarity.Common.Weapon", "일반 무기 루트");
